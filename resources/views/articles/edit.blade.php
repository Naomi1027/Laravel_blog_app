...
<div class="mt-20 mx-auto w-4/5">
    <form method="POST" action="{{ route('articles.update', ['articleId' => 2]) }}">
        @csrf
        <div class="w-full">
            <div class="mb-6">
        ...
        <div class="flex gap-12 justify-center">
            <a href="{{ route('articles.show', ['articleId' => 2 ]) }}" class="w-24 text-center rounded-md bg-blue-700 p-2 inline-block tracking-normal text-white font-bold">戻る</a>
