...
<div class="mt-20 mx-auto w-full">
    ...
    <section class="border-2 border-gray-400 mt-4 p-8">
        ...
        <div class="flex mb-4">
            ...
            <div class="flex-col space-y-2 ml-auto">
                ...
                <a href="{{ route('comments.edit', ['articleId' => $article->id, 'commentId' => $comment->id]) }}" class=" h-10 w-24 text-center rounded-md bg-cyan-400 p-2 inline-block tracking-normal text-white font-bold">編集する</a>
    ...
    <section class="border-2 border-gray-400 mt-4 p-8">
        ...
        <form method="POST" action="{{ route('comments.store', ['articleId' => $article->id]) }}">
            @csrf
            <div class="mb-6">
